...
import { mainReducerCreator } from "../../redux/main_reducer/main_reducer_creator";
  ...
  return (
    ...
    >
      <div className={classes.popap}>
        ...
        <div
          className={
            visibleApplicationSened
              ? `${classes.applicationSended} ${classes.hide}`
        ...
        <Svg
          onClick={() => dispatch(mainReducerCreator(false))}
          styles={classes.cross}
          id="cross"
        />
      </div>
    </div>
