...
const Popap = ({ dispatch, mainPage: { popapIsOpen } }) => {
  ...
  const [visibleApplicationSened, setVisibleApplicationSended] =
    useState(false);
  ...
  const submitForm = (event) => {
    ...
    setVisibleApplicationSended(true);
    setTimeout(() => {
      setVisibleApplicationSended(false);
    }, 2000);
  };
  ...
  const clickBackground = (e) => {
    if (e.target.className === classes.background) {
      ...
      <div className={classes.popap}>
        <div className={classes.container}>
          ...
          <form onSubmit={submitForm}>
            ...
            <input ref={checkBox} id="checkbox-1" type="checkbox" />
          </form>
        </div>
        <div
          className={
