  ...
  return (
    <div className={classes.centralBlock}>
      ...
      <div className={classes.answerSomeQuestions}>
        ...
        <p className={classes.answerSomeQuestions__text}>
          <span className={classes.answerSomeQuestionsBoldText}>
            {" "}
            Ответьте на несколько <br /> вопросов и получите
          </span>{" "}
          сметную <br /> стоимость и 3 подарка за <br /> экономию нашего времени
        </p>
      </div>
    </div>
  );
